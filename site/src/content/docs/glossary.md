---
title: "형사절차 핵심 용어 사전"
description: "학습용. 헷갈리는 용어들을 \"왜 이 단어가 필요한가 / 어디서 쓰이는가\" 중심으로 정리."
sidebar:
  order: 2
---
...
| 3심 (상고) | 대법원 | **법률 적용**만 (사실관계는 원칙 X) | **법률심** |
...
| 항소이유서 제출 | **소송기록접수통지서 받은 날부터 20일 이내** | **2심 관할법원** (원심 X) | 구체적 사유 작성 |
...
> 변호인 조력은 **헌법 권리**. 돈 없다고 포기 X — 국선 있음. 단, **첫 조사 전**에 결정해야 의미 있음.
